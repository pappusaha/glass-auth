...
const {email, password}=data
 ...
 .then(result => console.log('asdfas',result))
 .catch((error)=> console.error(error))
      }

    return (
        <div className="flex flex-col w-4/12 mx-auto p-6 rounded-md sm:p-10 dark:bg-gray-50 dark:text-gray-800">
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate="" action="" className="space-y-12">
            ...
            <div className="space-y-2">
                ...
                <p className="px-6 text-sm text-center dark:text-gray-600">Don't have an account yet?
                  <Link to={'/register'}>   <button rel="noopener noreferrer" href="#" className="hover:underline dark:text-violet-600">Sign up</button> </Link>
                </p>
            </div>
        </form>
    </div>
